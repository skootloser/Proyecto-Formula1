/*
"Medir el número de vueltas más rápidas registrada por cada piloto en 2017"

Esta vista cuenta el número de veces que cada piloto ha registrado
la vuelta más rápida en una carrera durante el año 2017.
...
DROP VIEW IF EXISTS "main"."VueltasRapidasPorPiloto2017";

-- Creamos la vista para contar las vueltas más rápidas por piloto en 2017
CREATE VIEW VueltasRapidasPorPiloto2017 AS
...
-- Para consultar el resultado: SELECT * FROM VueltasRapidasPorPiloto2017;