...
Datos El estudio se desarrolla en base a un archivo de registros de datos sobre las temporadas de la F1 durante 1950 – 2017, conformado por 13 tablas las cuales definiremos para trabajar con las de nuestro interés: - Circuitos: Conforma la locación, condición y su nombre.
...
Grafico_2013 <- ggplot(Mejores_2013, aes(x = paste(Nombre, Apellido), y = Puntos)) +
   geom_bar(fill = "red", stat = "identity") +
