...
Mejores_pilotos_2013 <- "SELECT d.driverId AS ID_Pilotos,
...
Mejores_pilotos_2013 <- dbGetQuery(con, Mejores_pilotos) 
...
Mejores_pilotos_2014 <- "SELECT d.driverId AS ID_Pilotos,
       d.forename AS Nombre,
       d.surname AS Apellido,
       s.year AS temporada,   
       SUM(CASE WHEN r.position = 1 THEN 1 ELSE 0 END) AS Podios_1,
