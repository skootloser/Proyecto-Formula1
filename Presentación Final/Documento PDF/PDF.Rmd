...
INNER JOIN races s ON s.raceId = r.raceId
WHERE 
 r.position BETWEEN 1 and 3 AND s.year = 2013 AND 2017
GROUP BY 
  d.forename, 
  d.surname,
  r.position
...
Mejores_pilotos_2013_2017 <- dbGetQuery(con, Mejores_pilotos) 
