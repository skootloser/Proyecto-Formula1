...
```{r}
Grafico_2017 <- ggplot(Mejores_2017, aes(x = paste(Nombre, Apellido), y = TotalPuntos)) +
   geom_bar(fill = "red", stat = "identity") +
   labs(title = "Mejores corredores 2017",
        x = "Piloto",
        y = "Puntos Totales")
 print(Grafico_2017)      
...
```{r}
Grafico_2016 <- ggplot(Mejores_2016, aes(x = paste(Nombre, Apellido), y = TotalPuntos)) +
   geom_bar(fill = "red", stat = "identity") +
   labs(title = "Mejores corredores 2016",
        x = "Piloto",
        y = "Puntos Totales")
 print(Grafico_2016)      
...
```{r}
Grafico_2015 <- ggplot(Mejores_2015, aes(x = paste(Nombre, Apellido), y = TotalPuntos)) +
   geom_bar(fill = "red", stat = "identity") +
   labs(title = "Mejores corredores 2015",
        x = "Piloto",
        y = "Puntos Totales")
 print(Grafico_2015)      
...
```{r}
Grafico_2014 <- ggplot(Mejores_2014, aes(x = paste(Nombre, Apellido), y = TotalPuntos)) +
   geom_bar(fill = "red", stat = "identity") +
   labs(title = "Mejores corredores 2014",
        x = "Piloto",
        y = "Puntos Totales")
 print(Grafico_2014) 
```
...
```{r}
Grafico_2013 <- ggplot(Mejores_2013, aes(x = paste(Nombre, Apellido), y = TotalPuntos)) +
   geom_bar(fill = "red", stat = "identity") +
   labs(title = "Mejores corredores 2013",
        x = "Piloto",
        y = "Puntos Totales")
 print(Grafico_2013) 
```
