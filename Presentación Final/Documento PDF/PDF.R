...
print(tablas)
#Salida para archivo excel
install.packages("writexl")
library(writexl)

# Query y creacion de data frame
...
circuitos_con_mascarreras <- dbGetQuery(con, circuitos_carreras_5) #de esta forma obtenemos los 5 circuitps con mas carreras
