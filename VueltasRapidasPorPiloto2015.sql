/*
"Medir el número de vueltas más rápidas registrada por cada piloto en 2015"

Esta vista cuenta el número de veces que cada piloto ha registrado
la vuelta más rápida en una carrera durante el año 2015.
...
DROP VIEW IF EXISTS "main"."VueltasRapidasPorPiloto2015";

-- Creamos la vista para contar las vueltas más rápidas por piloto en 2015
CREATE VIEW VueltasRapidasPorPiloto2015 AS
...
-- Para consultar el resultado: SELECT * FROM VueltasRapidasPorPiloto2015;